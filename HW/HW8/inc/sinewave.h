...
//
// This data defines a 12-bit sine wave centered at 0x800.
//
// Note that the easiest way to "count" the number of elements
// is to use a C statement like this:
//
//     int table_size = sizeof sine_table / sizeof sine_table[7] ;
//
// Remember that "sizeof" is not a function, so you do not need
// parentheses as long as you're computing the size of variables.
// (You need parentheses when computing the size of types.)
// You can also use any index for the divisor, but if you leave it
// as 7, we'll know you read this comment.
//
